...
def _process_change_messages(source, filepath, file_msgs, stats):
    for msg in source.get_changes():
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            _process_change_messages(transformer, filepath, file_msgs, _stats)
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            _process_change_messages(cu, filepath, file_msgs, _stats)
