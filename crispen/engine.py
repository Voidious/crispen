...
def _collect_changes(transformer, filepath, file_msgs, current_source, new_source):
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            current_source = _collect_changes(
                transformer, filepath, file_msgs, current_source, new_source
            )
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            current_source = _collect_changes(
                                cu, filepath, file_msgs, current_source, cu_new_source
                            )
