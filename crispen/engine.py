...
def _record_change_messages(get_changes, filepath: str, file_msgs, _stats) -> None:
    for msg in get_changes():
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            _record_change_messages(
                transformer.get_changes, filepath, file_msgs, _stats
            )
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            _record_change_messages(
                                cu.get_changes, filepath, file_msgs, _stats
                            )
