...
def _record_change_messages(change_provider, filepath: str, file_msgs, _stats) -> None:
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            _record_change_messages(transformer, filepath, file_msgs, _stats)
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            _record_change_messages(cu, filepath, file_msgs, _stats)
