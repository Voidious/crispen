...
def _record_changes_and_update_source(file_msgs, filepath, transformer, new_source):
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            current_source = _record_changes_and_update_source(
                file_msgs, filepath, transformer, new_source
            )
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            current_source = _record_changes_and_update_source(
                                file_msgs, filepath, cu, cu_new_source
                            )
