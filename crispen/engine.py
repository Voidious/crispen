...
def _collect_changes(transformer, filepath, file_msgs, _stats):
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            _collect_changes(transformer, filepath, file_msgs, _stats)
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            _collect_changes(cu, filepath, file_msgs, _stats)
