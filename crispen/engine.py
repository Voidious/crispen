...
def _apply_transformer_and_collect_msgs(
    transformer, new_source: str, filepath: str, file_msgs: List[str]
) -> str:
...
def run_engine(
    ...
    for filepath, ranges in changed.items():
        ...
        for RefactorClass in _REFACTORS:
            ...
            current_source = _apply_transformer_and_collect_msgs(
                transformer, new_source, filepath, file_msgs
            )
                ...
                if private_transforms:
                    ...
                    if cu_new_source != current_source:
                        try:
                            ...
                            current_source = _apply_transformer_and_collect_msgs(
                                cu, cu_new_source, filepath, file_msgs
                            )
