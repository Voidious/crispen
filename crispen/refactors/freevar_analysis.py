...
from .ast_parsing import _try_parse_ast_source, _try_parse_dedent_block
...
def _missing_free_vars(
    ...
    """
    block_tree = _try_parse_dedent_block(block_src)
    ...
    source_tree = _try_parse_ast_source(source)
