...
from .ast_utils import _collect_called_names
...
from .checks import _has_call_to
from .checks import (
...
from .collectors import _collect_attribute_names  # noqa F401
from .duplicates import _find_duplicate_groups
from .edits import _apply_edits, _find_insertion_point
from .escaping_vars import _find_escaping_vars
from .exceptions import _ApiTimeout
from .extractors import _extract_defined_names
from .filtering import _filter_maximal_groups  # noqa F401
from .fingerprints import _build_function_body_fps
from .free_vars import _missing_free_vars
from .helpers import _helper_imports_local_name, _strip_helper_docstring
from .indentation import _normalize_replacement_indentation
...
from .names_assigned import _names_assigned_in  # noqa F401
from .normalizer import _normalize_source  # noqa F401
from .overlap import _overlaps_diff
from .pyflakes_utils import _pyflakes_new_undefined_names
from .replacement import _build_helper_insertion, _replacement_steals_post_block_line
from .return_analysis import _replacement_contains_return, _seq_ends_with_return
from .timeout import _run_with_timeout
from .verification import _verify_extraction
