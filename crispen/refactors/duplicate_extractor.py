...
from .analysis_graph_utils import _build_function_body_fps
from .analysis_graph_utils import _has_def  # noqa F401
from .analysis_graph_utils import _node_weight  # noqa F401
from .analysis_graph_utils import _sequence_weight  # noqa F401
from .analysis_groups_utils import _find_duplicate_groups, _overlaps_diff
from .analysis_groups_utils import _filter_maximal_groups  # noqa F401
from .analysis_scope_utils import _extract_defined_names, _find_escaping_vars
from .analysis_scope_utils import _names_assigned_in  # noqa F401
from .ast_utils import _normalize_source  # noqa F401
from .blocks import _MAX_SEQ_LEN, _MIN_WEIGHT, _MODEL
from .collectors import _FunctionCollector, _SequenceCollector, _collect_called_names
from .helpers import (
    _apply_edits,
...
from .imports import _helper_imports_local_name
...
from .verification import _collect_attribute_names  # noqa F401
from .verification import _has_mutable_literal_is_check  # noqa F401
from .verification import _has_param_overwritten_before_read  # noqa F401
...
class DuplicateExtractor(Refactor):
    ...
    @staticmethod
    def _handle_llm_validation_result(is_valid, reason, verbose, stats):
        if verbose:
        ...
        if self._match_functions and func_body_fps:
            for seq in collector.sequences:
                ...
                try:
                    ...
                    continue
                if self._handle_llm_validation_result(
                    is_valid, reason, self.verbose, self.stats
                ):
                    continue
