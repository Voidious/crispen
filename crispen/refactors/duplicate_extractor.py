...
from .analysis_call_graph import _collect_called_names
from .analysis_diff_utils import _overlaps_diff
from .analysis_function_bodies import _build_function_body_fps
from .analysis_group_filter import _filter_maximal_groups  # noqa F401
from .analysis_grouping_utils import _find_duplicate_groups
...
from .imports import _extract_defined_names, _helper_imports_local_name
...
from .static_analysis import _collect_attribute_names  # noqa F401
from .static_analysis import _has_mutable_literal_is_check  # noqa F401
from .static_analysis import _has_param_overwritten_before_read  # noqa F401
...
from .verification import _names_assigned_in  # noqa F401
...
class DuplicateExtractor(Refactor):
    ...
    @staticmethod
    def _log_and_handle_validation_result(is_valid, reason, verbose, stats):
        if verbose:
        ...
        if self._match_functions and func_body_fps:
            for seq in collector.sequences:
                ...
                try:
                    ...
                    continue
                if self._log_and_handle_validation_result(
