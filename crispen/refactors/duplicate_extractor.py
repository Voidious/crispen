...
from .ast_name_collection import _collect_called_attr_names
from .ast_name_collection import _collect_attribute_names  # noqa F401
from .ast_normalization import _normalize_source  # noqa F401
from .ast_return_analysis import _seq_ends_with_return
from .ast_safety_checks import _has_call_to
from .ast_safety_checks import _has_mutable_literal_is_check  # noqa F401
from .ast_utils import _has_def  # noqa F401
from .call_generation import _generate_no_arg_call, _llm_generate_call
from .callgraph_utils import _collect_called_names
from .collectors import _FunctionCollector, _SequenceCollector
from .dataflow_checks import _has_param_overwritten_before_read  # noqa F401
from .defined_names import _extract_defined_names
from .duplicate_extraction import _MAX_SEQ_LEN, _MIN_WEIGHT, _MODEL
from .duplicate_groups import _find_duplicate_groups
from .duplicate_groups import _filter_maximal_groups  # noqa F401
from .edit_application import _apply_edits
from .escaping_vars import _find_escaping_vars
from .extraction_verification import _verify_extraction
from .fingerprints import _build_function_body_fps
from .freevar_analysis import _missing_free_vars
from .helper_insertion import _build_helper_insertion
from .indentation_utils import _normalize_replacement_indentation
from .insertion_point import _find_insertion_point
from .llm_extract import _llm_extract
from .llm_verify import _llm_verify_extraction
from .llm_veto import _llm_veto, _llm_veto_func_match
from .models import _FunctionInfo, _SeqInfo  # noqa F401
from .name_resolution import _helper_imports_local_name
from .name_resolution import _names_assigned_in  # noqa F401
from .overlap_utils import _overlaps_diff
from .pyflakes_utils import _pyflakes_new_undefined_names
from .replacement_analysis import (
    _replacement_contains_return,
    _replacement_steals_post_block_line,
)
from .source_cleaning import _strip_helper_docstring
from .timeouts import _ApiTimeout, _run_with_timeout
from .weights import _node_weight, _sequence_weight  # noqa F401
...
class DuplicateExtractor(Refactor):
    ...
    @staticmethod
    def _verbose_llm_veto_report(verbose, is_valid, reason, stats):
        if verbose:
        ...
        if self._match_functions and func_body_fps:
            for seq in collector.sequences:
                ...
                try:
                    ...
                    continue
                if self._verbose_llm_veto_report(
                    self.verbose, is_valid, reason, self.stats
                ):
                    continue
