...
import ast
import textwrap
from ..collectors import _FunctionInfo, _SeqInfo
from .utils import _MUTABLE_CONSTRUCTORS, _collect_ast_store_names, _is_pure_literal
from .scope_analysis import _has_param_overwritten_before_read
