...
from .duplicate_detection import _VETO_TOOL
from .duplicate_extraction import _MODEL
from .models import _FunctionInfo, _SeqInfo


def _unpack_llm_veto_result(result):
...
def _llm_veto(
    ...
    return _unpack_llm_veto_result(result)
