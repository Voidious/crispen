...
from .checks import _has_mutable_literal_is_check, _has_param_overwritten_before_read
from .parsing import _parse_source_and_init_set, _parse_source_with_init_set
...
def _missing_free_vars(
    ...
    """
    block_tree, reads = _parse_source_with_init_set(block_src, "reads")
    ...
    source_tree = _parse_source_and_init_set(source)
