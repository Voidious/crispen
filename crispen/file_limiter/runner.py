...
def _append_file_cannot_be_split_skip(
...
def run_file_limiter(
    ...
    return _attempt_file_split_with_retries(
        classified,
        config,
        existing_files,
        filepath,
...
def _attempt_file_split_with_retries(
    classified,
    config,
    existing_files,
    filepath,
    ...
    return _split_file_with_retries(
        classified,
        config,
        existing_files,
        filepath,
...
def _split_file_with_retries(
    ...
    for _attempt in range(max_attempts):
        ...
        if plan.abort:
            last_abort = _append_file_cannot_be_split_skip(
                plan.abort_reason,
                filepath,
                retry_msgs,
            )
