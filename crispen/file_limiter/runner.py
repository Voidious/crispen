...
def _run_file_limiter_with_retries(
    ...
    for _attempt in range(max_attempts):
        ...
        if plan.abort:
            last_abort = _record_abort_skip(retry_msgs, filepath, plan.abort_reason)
        ...
        if split.abort:
            last_abort = _record_abort_skip(retry_msgs, filepath, split.abort_reason)
