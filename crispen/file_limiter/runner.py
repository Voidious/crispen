...
def _execute_file_split(
    ...
    for _attempt in range(max_attempts):
        ...
        if plan.abort:
            _append_skip_message(plan.abort_reason, filepath, retry_msgs)
            last_abort = True
        ...
        if split.abort:
            _append_skip_message(split.abort_reason, filepath, retry_msgs)
            last_abort = True
