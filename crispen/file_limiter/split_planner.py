...
from .dependency_utils import _extract_shared_helpers
...
from .project_paths import _abs_package_for_dir, _collect_external_imported_names
from .split_transformers import _add_re_exports, _remove_entity_lines
