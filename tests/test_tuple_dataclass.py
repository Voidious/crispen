...
def _create_td(source: str, min_size: int = 3) -> TupleDataclass:
    tree = cst.parse_module(source)
    td = TupleDataclass([(1, 100)], min_size=min_size)
...
def _make_td_for_public_func_3() -> TupleDataclass:
    ...
    return _create_td(BEFORE_PUBLIC_FUNC_3)
