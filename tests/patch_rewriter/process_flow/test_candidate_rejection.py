...
from .. import test_apply_patch_rewrite
from ..test_apply_patch_rewrite import _PATCH_CALL_PR, _PATCH_GET_KEY_PR
...
@mock_patch(test_apply_patch_rewrite._PATCH_MAKE_CLIENT)
