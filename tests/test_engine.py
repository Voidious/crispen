...
def _create_test_pkg_with_service_and_api(tmp_path):
...
def test_cross_file_transforms_public_func_and_caller(tmp_path):
    pkg, service, api = _create_test_pkg_with_service_and_api(tmp_path)
...
def _setup_cross_file_test_pkg(tmp_path, pkg_name="mypkg"):
...
def test_cross_file_caller_updater_parse_error(tmp_path):
    pkg, service, changed = _setup_cross_file_test_pkg(tmp_path, "mypkg")
