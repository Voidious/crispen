...
def _make_service_and_api_pkg(tmp_path):
...
def test_cross_file_transforms_public_func_and_caller(tmp_path):
    pkg, service, api = _make_service_and_api_pkg(tmp_path)
...
def _run_and_assert_outside_caller(service, tmp_path):
...
def test_cross_file_skips_when_outside_caller_exists(tmp_path):
    ...
    _run_and_assert_outside_caller(service, tmp_path)
