...
def _build_wrapper_and_caller_updater(
    source, transforms=None, ranges=None, file_module="mypkg.api"
):
...
def _apply(source, transforms=None, ranges=None, file_module="mypkg.api"):
    wrapper, cu = _build_wrapper_and_caller_updater(
        source, transforms=transforms, ranges=ranges, file_module=file_module
    )
