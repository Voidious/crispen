...
def _parse_and_create_caller_updater(source, transforms, ranges, file_module):
...
def _apply(source, transforms=None, ranges=None, file_module="mypkg.api"):
    cu, wrapper = _parse_and_create_caller_updater(
        source, transforms, ranges, file_module
    )
