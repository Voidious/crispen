...
from tests.engine_duplicate_extractor_spies import _setup_duplicate_extractor_init_spy
...
def test_engine_match_function_disabled_passes_flag_to_duplicate_extractor(tmp_path):
    ...
    f, constructed_with, original_init = _setup_duplicate_extractor_init_spy(tmp_path)
