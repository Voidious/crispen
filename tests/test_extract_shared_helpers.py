...
from tests.test_helpers import _classified, _make_classified, _make_entity, _plan
...
def _call_extract_shared_helpers(
    entity_source_map,
    entity_map,
    classified,
    migrated_names,
...
def test_extract_shared_helpers_scc_prevents_new_to_new_cycle():
    ...
    file_entity_names, name_to_target_file, synthetic = _call_extract_shared_helpers(
        entity_source_map,
        entity_map,
        classified,
        migrated_names,
