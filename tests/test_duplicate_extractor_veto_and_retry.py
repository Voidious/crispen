...
from tests.dup_extractor_anthropic_retry_fixture import (
    _setup_anthropic_retry_on_alg_failure_mocks,
)
from tests.duplicate_extractor_test_responses import (
    _make_extract_response,
    _make_verify_response,
)
from tests.test_duplicate_extractor_veto_and_retry_fixtures import (
...
def test_extraction_retry_on_alg_failure_verbose(monkeypatch, capsys):
    ...
    helper = "def _helper(data):\n    pass\n"
    with patch("crispen.llm_client.anthropic") as mock_anthropic:
        mock_client = _setup_anthropic_retry_on_alg_failure_mocks(
