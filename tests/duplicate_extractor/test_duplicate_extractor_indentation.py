from crispen.refactors.duplicate_extractor import _normalize_replacement_indentation
from .test_duplicate_extractor_indentation_utils import _make_seq_with_source
